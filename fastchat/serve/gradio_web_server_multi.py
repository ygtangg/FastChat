...
def build_visualizer():
    ...
    with gr.Tabs():
        ...
        with gr.Tab("Price Analysis", id=1):
            ...
            Below is a scatterplot displays a selection of the arena's models, showing their scores plotted against their cost-effectiveness. Start exploring!
            """
            ...
            frame = """
                <iframe width="100%" scrolling="no" style="height: 1050px; border: 1px solid lightgrey; border-radius: 10px;" 
                        src="https://storage.googleapis.com/public-arena-no-cors/arena-scatterplot.html">
                </iframe>
            """
            gr.HTML(frame)
